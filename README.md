...
> [!IMPORTANT]  
> With Firefox 133 and above, **this theme will not work** as an update breaks the navigation bar. For now I recommend either disabling this theme or switching to a different one until it is resolved (tracked in [#35](https://github.com/soup-bowl/Modoki-Firefox/issues/35).
